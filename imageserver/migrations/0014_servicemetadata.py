# Generated by Django 2.2.11 on 2020-05-06 04:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('imageserver', '0013_service_legend'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='imageserver.Service', related_name='metadata')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='imageserver_servicemetadata_metadata', to='giscube.MetadataCategory', to_field='code')),
            ],
            options={
                'abstract': False,
            },
