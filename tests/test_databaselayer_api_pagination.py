...
class DataBaseLayerAPIPaginationTestCase(BaseTest):
    def setUp(self):
    ...
    def test_metadata(self):
        ...
        self.layer.page_size = 25
        self.layer.max_page_size = 1000
        self.layer.save()
    ...
    def test_allow_page_size_0(self):
        ...
        self.assertEqual(len(response.json()['features']), len(self.locations))
