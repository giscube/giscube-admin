# Generated by Django 2.2.11 on 2020-05-05 12:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='giscube.Dataset', related_name='metadata')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='giscube_datasetmetadata_metadata', to='giscube.MetadataCategory', to_field='code')),
            ],
            options={
                'abstract': False,
            },
